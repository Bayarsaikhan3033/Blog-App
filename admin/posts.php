...
<?php $posts = getAllPosts(); ?>
	<title>Admin | Нийтлэл хянах</title>
</head>
<body>
	...
	<div class="container content">
		...
		<div class="table-div"  style="width: 80%;">
			...
			<?php if (empty($posts)): ?>
				<h1 style="text-align: center; margin-top: 20px;">Одоогоор нийтлэл байхгүй байна.</h1>
			<?php else: ?>
				<table class="table">
						<thead>
						<th>N</th>
						...
						<?php if ($_SESSION['user']['role'] == "Admin"): ?>
							<th><small>Нийтлэх</small></th>
						<?php endif ?>
						<th><small>Засварлах</small></th>
						<th><small>Устгах</small></th>
					</thead>
					<tbody>
